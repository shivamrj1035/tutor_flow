...
const AddCourse = () => {
    ...
    const createCourseHandler = async () => {
        if (!courseTitle.trim()) {
            toast.error("Please fill course title");
            return;
        }
        if (!category) {
            toast.error("Please fill course category.");
            return;
        }
    ...
    return (
        <div className="flex-1 mx-10 gap-10">
            <div className="mb-4">
                ...
                <p className="text-sm text-gray-600 mt-2 dark:text-gray-300">
                    Start by adding some essential details to bring your course to life.
                </p>
            </div>
            <div className="space-y-4">
                <div>
                    ...
                    <Input
                        ...
                        placeholder="Give course name here"
                    />
                </div>
                <div>
